  ...
  const products = [
    {
      ...
      description:
        "Perfect for beginners jo air ka taste lena chahte hain without commitment!",
      features: [
      ...
      popular: false,
      savage:
        "For people who think free lunch exists aur unicorns are real 🤡🦄",
    },
    {
      name: "Chad Hawa Pro",
      price: "₹999",
      period: "Per Month",
      description:
        "For serious hawa-dicts who want premium breathing experience with extra bakwas!",
      features: [
      ...
      popular: true,
      savage:
        "Most popular among people with functioning brain cells (rare species) 🧠⚡",
    },
    {
      ...
      period: "Per Month",
      description:
        "For absolute madlads jo deserve karte hain the finest hawa that money can buy!",
      features: [
    ...
    },
    {
      ...
      period: "Lifetime",
      description:
        "Complete madness for those who have lost all sense of reality!",
      features: [
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {products.map((product, index) => (
            <Card
              key={index}
              className={`relative group hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 hover:rotate-1 ${
                product.popular
                  ? "border-4 border-orange-400 scale-105 animate-pulse"
            ...
            >
              ...
              <CardContent className="p-6 text-center">
                ...
                <div className="mb-6 flex justify-center">
                  <div
                    className={`p-4 bg-gradient-to-r ${product.gradient} rounded-full group-hover:scale-110 group-hover:rotate-12 transition-transform animate-pulse`}
                  >
                ...
                {/* Price */}
                <div className="mb-4">
                  <span className="text-3xl font-black text-gradient animate-pulse">
                    {product.price}
                  </span>
                ...
                <Button
                  ...
                  } text-white py-3 font-bold rounded-full transform hover:scale-105 hover:rotate-3 transition-all text-sm`}
                >
                  {product.price === "₹0" ? "Start Free" : "Upgrade Kar Bhai"}
                </Button>
              </CardContent>
            </Card>
          ))}
        ...
        <div className="mt-12 text-center">
          <p className="text-sm text-gray-500 italic animate-bounce">
            *All plans come with unlimited oxygen (hopefully). Premium plans
            include nitrogen aur trace amounts of confusion for enhanced
            stupidity.
          </p>
